...
def get_parent_from_id(concept_id):
    ...
    return current_parent_id[:-1] if current_parent_id else '', concept_id 
...
def main():
    ...
    for concept in concepts_stream:
        ...
        concept_set_label(concepts, concept_id, concept_variants_label, concept_variants_preflabel)
