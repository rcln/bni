        ...
        <main class="content mdl-layout__content">
            <section class="mdl-grid">
                <div class="mdl-cell--6-col">
                    <div class="header-img-avatar--secondary" onClick="window.open('adam-smith/', '_self');">
                        <div class="img-container">
                            <img class="img-avatar--secondary" src="adam-smith.jpg" style="margin-left: -3vh;">
                        </div>
                        <h6 class="main-title--secondary">Immersion in the work of <br>Adam Smith</h6>
                    </div>
                </div>
                <div class="mdl-cell--6-col">
                    <form action="search/" class="search search--secondary" autocomplete="off">
