...
<body class="">
        ...
        <header class="header mdl-layout__header">
            <div class="mdl-layout__header-row">
                <span class="mdl-layout-title">
                    <a href="#">Welcome to the Digital Library of Ideas</a>
                </span>
        ...
        <main class="content mdl-layout__content">
            <section class="mdl-grid">
                <div class="mdl-cell--6-col">
                    <div class="header-img-avatar--secondary" onClick="window.open('francis-hutcheson/', '_self');" >
                        <div class="img-container">
                            <img class="img-avatar--secondary" src="francis-hutcheson.jpg" style="margin-left: -3vh;">
                        </div>
                        <h6 class="main-title--secondary">Immersion in the work of <br>Francis Hutcheson</h6>
                    </div>
                </div>
                <div class="mdl-cell--6-col">
                    <form action="en/francis-hutcheson/search-fh/" class="search search--secondary" autocomplete="off">
                        <div class="mdl-textfield mdl-js-textfield">
                            <input id="query" class="mdl-textfield__input" type="text" 
                                placeholder="Search" value="<?php echo $_REQUEST["query"];?>" >
                        </div>
                ...
                <div id="result" class="mdl-cell 
                        ...
                        <div style="background-color: transparent;" class="mdl-card mdl-card--expand mdl-cell mdl-cell--12-col">
                            <div class="query-from mdl-card__supporting-text  mdl-cell mdl-cell--12-col">
                                <span class="mdl-color-text--blue-grey-900">Results:</span> 
                            ...
                            <div id="result-not-found" class="mdl-card__supporting-text mdl-cell mdl-cell--12-col" style="display: none;">
                                <h5 class="center">"<b><?php echo $_REQUEST["query"];?></b>" not found.</h5>
                            </div>
                            <div id="result-items" class="mdl-cell mdl-cell--12-col" style="display: none;" >
                                <div class="mdl-card__title">
                                    <h4 class="mdl-card__title-text mdl-color-text--deep-orange-900">By work</h4>
                                </div>
                                <div id="works">
                                </div>
                            </div>
    ...
    <script>
        var url_thesaurus = "data/thesaurus/bni-thesaurus-francis-hutcheson-en.json";
        var default_author_search = "/bni/en/francis-hutcheson/search-fh/";
