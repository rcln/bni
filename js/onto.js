...
edges.push({from: 'Approbation', to: 'Self-interest'});
...
edges.push({from: 'Division_of_labour', to: 'Consent'});
edges.push({from: 'Division_of_labour', to: 'Difference_of_talent'});
edges.push({from: 'Division_of_labour', to: 'Equality'});
edges.push({from: 'Division_of_labour', to: 'Obligation'});
edges.push({from: 'Division_of_labour', to: 'Promise'});
...
edges.push({from: 'Division_of_labour', to: 'deal'});
...
edges.push({from: 'Human_nature', to: 'imagination'});
...
edges.push({from: 'Obedience', to: 'Corporation'});
edges.push({from: 'Obedience', to: 'abundance'});
edges.push({from: 'Obedience', to: 'neighbour'});
...
edges.push({from: 'Philosophy', to: 'Laws'});
...
edges.push({from: 'Political_philosophy', to: 'Impartial_spectator'});
...
edges.push({from: 'Sympathy', to: 'Human_nature'});
edges.push({from: 'Sympathy', to: 'Impartial_spectator'});
edges.push({from: 'Sympathy', to: 'Infancey'});
edges.push({from: 'Sympathy', to: 'Judgment'});
...
edges.push({from: 'Vanity', to: 'Poor'});
...
edges.push({from: 'merchant', to: 'butcher'});
edges.push({from: 'theory', to: 'Impartial_spectator'});
...
// create a network
    ...
    var options = {
            ...
            physics: {
                    ...
                    maxVelocity: 146,
                    solver: 'repulsion', //hierarchicalRepulsion //barnesHut //repulsion //forceAtlas2Based
                    timestep: 0.35,
                    stabilization: {
                        enabled:true,
                        iterations:2000,
